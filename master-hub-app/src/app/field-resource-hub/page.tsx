  ...
  return <main style={{minHeight:"100vh",background:"#080b12",color:"#f4f4f7",fontFamily:"Arial,sans-serif",padding:24}}>
    <div style={{maxWidth:1200,margin:"0 auto",display:"grid",gap:18}}>
      ...
      <section style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(280px,1fr))",gap:12}}>
        <a href="https://field-diagnostic-hub.vercel.app" target="_blank" rel="noreferrer" style={card}><strong>Field Diagnostic Hub</strong><span style={{fontSize:12,color:"#8c94a5"}}>Open the live diagnostic and troubleshooting system.</span><span style={{fontSize:11,color:"#a99eff"}}>Open live hub →</span></a>
        <Link href="/repair-packages" style={card}><strong>Repair Packages & Rebuild Kits</strong><span style={{fontSize:12,color:"#8c94a5"}}>Compile parts, build complete repair packages, run coverage checks and copy a costed parts table.</span><span style={{fontSize:11,color:"#a99eff"}}>Open repair packages →</span></Link>
      </section>
