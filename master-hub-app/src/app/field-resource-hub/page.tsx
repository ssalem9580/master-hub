  ...
  return <main style={{minHeight:"100vh",background:"#080b12",color:"#f4f4f7",fontFamily:"Arial,sans-serif",padding:24}}>
    <div style={{maxWidth:1200,margin:"0 auto",display:"grid",gap:18}}>
      ...
      <section style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(280px,1fr))",gap:12}}>
        <Link href="/field-diagnostic-hub" style={card}><strong>Field Diagnostic Hub</strong><span style={{fontSize:12,color:"#8c94a5"}}>Clean equipment hierarchy with VAT Department → Pneumatic Tubes / Drawers and interactive field diagnostics.</span><span style={{fontSize:11,color:"#74d8bd"}}>Open diagnostics →</span></Link>
